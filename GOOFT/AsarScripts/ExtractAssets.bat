...
:Start
echo Place a headerless GOOFT ROM named %ROMName% in this folder, then type the number representing what version %ROMName% is.
echo 0 = GOOFT (USA)
echo 1 = GOOFT (PAL)
echo 2 = GOOFT (Japan)
echo 3 = GOOFT (French)
...
echo You need to place a GOOFT ROM named %ROMName% in this folder before you can extract any assets^^!
goto :Mode
