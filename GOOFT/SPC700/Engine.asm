...
CODE_0A15:
	...
	CALL CODE_0CD6
	MOV Y, #$1C
	MOV A, DATA_0D10+$01+x
	CALL CODE_0CD6
	MOV A, DATA_0D10+$02+x
	MOV $CE, A
	MOV A, DATA_0D10+$03+x
	MOV $CF, A
	CALL CODE_0A6E
	MOV Y, #$6D
	MOV A, DATA_0D10+$04+x
	CALL CODE_0CD6
	MOV A, #$7D
	MOV $00F2, A
	MOV A, $00F3
...
CODE_0A4F:
	...
	MOV $CC, A
	MOV Y, #$0D
	MOV A, DATA_0D15+$01+x
	CALL CODE_0CD6
	MOV A, DATA_0D15+$02+x
	CALL CODE_0A87
	POP X
CODE_0A6D:
	RET
