...
; Note: Put your custom routine/data macros, references to them, and defines in this file from within the GOOFT_InsertIntegratedPatches and GOOFT_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro GOOFT_InsertIntegratedPatches()
...
macro GOOFT_ApplyPatchesPostAssembly()
...
macro GOOFT_HandleDefaultPatches()
